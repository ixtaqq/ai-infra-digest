...
export function registerDigestCommands(): void {
  ...
  // ─── /coverage command — per-article bullish/bearish trend for a ticker ──
  // Answers "is coverage of this ticker trending bullish or bearish, and why"
  // directly from the articles table (no schema change — every article
  // already carries impact/impact_score/reason and is never overwritten).
  ...
  // ─── /thesis command — weekly bull/bear thesis snapshot (v10) + history (v11) ──
